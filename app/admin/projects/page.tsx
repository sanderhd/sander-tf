...
export default function AdminProjectsPage() {
    ...
    return (
        ...
        >
            <h1 className="font-mono text-3xl tracking-tight text-gray-900 sm:text-4xl dark:text-white">Projects Management</h1>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Create and manage your projects.</p>
                ...
                <div className="mt-6 space-y-6">
                    ...
                    <AnimatePresence>
                        {formOpen && (
                            ...
                            >
                                <AdminProjectForm onCreated={handleCreated} />
                            </motion.div>
                        )}
                    </AnimatePresence>
